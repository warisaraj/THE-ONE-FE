export const environment = {
    ...
    ip: 'https://vtl-supplementary-be-develop.scapp.work', // https://vtl-supplementary-be-develop.scapp.work
    ipSocket: 'https://vtl-supplementary-be-develop.scapp.work', // https://vtl-supplementary-be-develop.scapp.work
    /** ต้องสอดคล้องกับ path จาก `public/` ไปยัง `pathImage` บน BE (เช่น `public/image` → `image`) */
