/**
 * ใช้กับ `npm run serve:local` — ชี้ API / Socket ไป BE ที่รันบนเครื่อง
 * พอร์ตต้องตรงกับ BE `config/app.config.json` → default.appPort (ปัจจุบัน 8897)
 */
export const environment = {
    ...
    ip: 'http://localhost:8897',
    ipSocket: 'http://localhost:8897',
