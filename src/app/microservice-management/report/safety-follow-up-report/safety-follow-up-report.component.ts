...
import {GlobalVariable} from './safety-follow-up-report.global';
...
@Component({
  selector: 'app-safety-follow-up-report',
  providers: [LayoutMenu, Request, Common],
  templateUrl: './safety-follow-up-report.component.html',
})
export class SafetyFollowUpReportComponent implements OnInit, AfterViewInit {
  ...
  async ngAfterViewInit() {
    try {
      ...
      this.locationTypeList = dropdown.locationTypeList
  ...
  clickDownload(){
    ...
    // this.downloadExcel()
    this.common.export('Safety_Follow_Up', this.filter, this.myModal);
  }
