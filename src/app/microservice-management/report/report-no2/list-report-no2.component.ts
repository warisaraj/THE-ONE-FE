...
import {GlobalVariable} from './list-report-no2.global';
...
@Component({
  selector: 'app-list-report-no2',
  providers: [LayoutMenu, Request, Common],
  templateUrl: './list-report-no2.component.html',
})
export class ListReportNo2Component implements OnInit, AfterViewInit {
  ...
  clickDownload(){
    ...
    // this.downloadExcel()
    this.common.export('Report_No2', this.filter, this.myModal);
  }
