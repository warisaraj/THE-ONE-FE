...
import {GlobalVariable} from './medication-dispensing-report.global';
...
@Component({
  selector: 'app-medication-dispensing-report',
  providers: [LayoutMenu, Request, Common],
  templateUrl: './medication-dispensing-report.component.html',
})
export class MedicationDispensingReportComponent implements OnInit, AfterViewInit {
  ...
  clickDownload(){
    ...
    // this.downloadExcel()
    this.common.export('Medication_Dispensing', this.filter, this.myModal);
  }
