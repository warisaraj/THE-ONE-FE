...
@Component({
    selector: 'app-list-assign-microservice-permission',
    providers: [LayoutMenu, Request, Common],
    templateUrl: './list-assign-microservice-permission.component.html',
})
export class ListAssignMicroservicePermissionComponent implements OnInit, AfterViewInit {
    [x: string]: any;
